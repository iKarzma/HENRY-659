...
let vn = './Menu.png'
let pp = imagen4
let img = await(await fetch('https://telegra.ph/file/be30b6f0bd6ca81dfce4c.jpg')).buffer()
...
*✍︎☢︎︎ اسـم الـبوت : هنري*🤩😍
*✍︎☢︎︎ حط قبل كل امر*  (.)
*✍︎☢︎︎ اســم الـمطور  KARZMA&SHEKO*🤩😍
...
👑┑━━━حـقـوق الـمـطـور━━━┍👑
*❗⇆ رقـم الـمطـور  ↯*
❗ده  https://wa.me/+201559987114
*❗⇆ رقـم الـمطـور  ↯*
❗ده  https://wa.me/+201203811547
👑┙━━━حـقـوق الـمـطـور━━━┕👑
`.trim()
